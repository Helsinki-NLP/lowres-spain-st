...
# Double tags, xxx for Aranese
#sed "s/^>>xxx<< />>oci<< >>xxx<< /" data/train/train.spa-ara.spa.xxx.tok > data/train/train.spa-ara.spa.oci-xxx.tok
#sed "s/^>>xxx<< />>oci<< >>xxx<< /" data/train/dev.src.xxx.ara.tok > data/train/dev.src.oci-xxx.ara.tok
#sed "s/^>>oci<< />>oci<< >>oci<< /" data/train/train.spa-oci.spa.tok > data/train/train.spa-oci.spa.oci-oci.tok

# Concat all train data with xxx tag for Aranese
#cat data/train/train.spa-arg.spa.tok data/train/train.spa-ast.spa.tok data/train/train.spa-oci.spa.oci-oci.tok data/train/train.spa-ara.spa.oci-xxx.tok > data/train/train.src.oci-xxx.ara.tok
...
# Output model
modeldir="models/opus+bibles_ft_all_xxx_3_bleu"
datadir="data/train"
...
${MARIAN}/marian --model "${modeldir}/model.npz" \
       ...
       --valid-sets "${datadir}/dev.src.oci-xxx.ara.tok" "${datadir}/dev.trg.tok"  \
       --train-sets "${datadir}/train.src.oci-xxx.ara.tok" "${datadir}/train.trg.tok" \
