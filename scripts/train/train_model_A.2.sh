#!/bin/bash
#SBATCH --job-name="finetune_spa-itc_no_oci"
#SBATCH -o logs/finetune_spa-itc_no_oci_bleu%j.out
#SBATCH -e logs/finetune_spa-itc_no_oci_bleu%j.err
...
# Output model
modeldir="models/opus+bibles_ft_no_oci_bleu"
datadir="data/train"
...
${MARIAN}/marian --model "${modeldir}/model.npz" \
       ...
       --train-sets "${datadir}/train_no_oci.src.tok" "${datadir}/train_no_oci.trg.tok" \
