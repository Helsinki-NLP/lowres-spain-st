...
# Substitute >>oci<< for >>xxx<< for Aranese
#sed "s/^>>oci<< />>xxx<< /" data/train/train.spa-oci.spa.tok > data/train/train.spa-oci.spa.xxx.tok

# Concat all train data with xxx tag for Aranese
#cat data/train/train.spa-arg.spa.tok data/train/train.spa-ast.spa.tok data/train/train.spa-oci.spa.xxx.tok data/train/train.spa-ara.spa.tok > data/train/train.src.xxx.oci.tok
...
# Output model
modeldir="models/opus+bibles_ft_all_xxx_2_bleu"
datadir="data/train"
...
${MARIAN}/marian --model "${modeldir}/model.npz" \
       ...
       --train-sets "${datadir}/train.src.xxx.oci.tok" "${datadir}/train.trg.tok" \
