...
# Output model
modeldir="models/debug_C.3/nmt_rbmt"
datadir="data/train"
...
#lang="oci"
#${MARIAN}/spm_encode --model $opusmodeldir/$spm_target data/debug_C.3/train.out.spa-${lang}.${lang} > data/debug_C.3/train.out.spa-${lang}.${lang}.tok
...
#cat ${distilldir}/train.out.spa-arg.arg.tok ${distilldir}/train.out.spa-ast.ast.tok data/debug_C.3/train.out.spa-oci.oci.tok data/debug_C.3/train.out.spa-ara.ara.tok > data/debug_C.3/train.out.trg.tok

# Fine-tune
${MARIAN}/marian --model "${modeldir}/model.npz" \
       -v "${opusmodeldir}/$vocab" "${opusmodeldir}/$vocab" \
       --train-sets "${datadir}/train.src.xxx.ara.tok" "data/debug_C.3/train.out.trg.tok" \
